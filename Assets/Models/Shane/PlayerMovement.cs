...
public class PlayerMovement : MonoBehaviour
{
    ...
    //SHANE EDITS: Adding a camera controller
    ...
    private void Start()
    {
        ...
        //SHANE EDITS: If the variable "MainCamera" is empty
        if(MainCamera == null)
        {
            //SHANE EDITS: this will search for the camera component
    ...
    private void Update()
    {
        ...
        //SHANE EDITS: This should stop the player from rotating a full 360 degrees
        pitch = Mathf.Clamp(pitch, -100, 90);

        // Rotate the player based off those mouse values we collected earlier
        transform.eulerAngles = new Vector3(0.0f, yaw, 0.0f);

        //SHANE EDITS: This will rotate the camera up and down based on mouse values calculated earlier
